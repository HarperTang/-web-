...
<html>
  ...
  <div class="container-fluid" >
			...
			<div id="div_bottom">
			<br/><br/>
				<form action="/online_class/addcourseServlet" method="post">
					课程名称&nbsp;&nbsp;&nbsp;<input type="text" name="course" style="width:20%"/><br/><br/>
					教师姓名&nbsp;&nbsp;&nbsp;<input type="text" name="teacher" style="width:20%"/><br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					课程信息&nbsp;&nbsp;&nbsp;<textarea rows="2" cols="40"></textarea><br/><br/>
